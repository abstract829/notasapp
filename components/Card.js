...
const Card = ({note}) => {
    ...
    const handleTitleEdit = async() => {
        ...
        if(isEditingTitle){
            ...
            inputCardTitle.className = 'block w-full text-xl font-bold break-words bg-sky-300'
    ...
    const handleBodyEdit = async() => {
        ...
        if(isEditingBody){
            ...
            inputCardBody.className = 'block w-full my-4 overflow-hidden text-lg break-words bg-sky-300'
            inputCardBody.focus()
        }
    }
    return (
        <div className="col-span-12 px-6 py-2 text-center rounded bg-sky-300 sm:col-span-6 md:col-span-4 lg:col-span-3 xl:col-span-2">
            <div className="flex justify-between gap-4 py-2">
                ...
                <h2 
                    ...
                    ref={cardTitleRef}
                    className="text-xl font-bold">{newTitle}</h2>
                <input 
            ...
            <p 
                ...
                ref={cardBodyRef} className="my-4 text-lg text-justify">{newBody}</p>
            <textarea 
                wrap='hard'
